...
public class SystemJobDO implements Serializable {

    private static final long serialVersionUID = 210621546021097067L;

    @TableId(value = "id", type = IdType.AUTO)
    @NotNull(message = "不能为null!", groups = {SystemJobDO.Update.class})
